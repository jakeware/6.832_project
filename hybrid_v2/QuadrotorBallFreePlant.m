classdef QuadrotorBallFreePlant < RigidBodyManipulator
  
  methods
    function obj = QuadrotorBallFreePlant()
      options.floating = true; 
      options.terrain = RigidBodyFlatTerrain();
      w = warning('off','Drake:RigidBodyManipulator:ReplacedCylinder');
      warning('off','Drake:RigidBodyManipulator:UnsupportedContactPoints');
      obj = obj@RigidBodyManipulator(getFullPathFromRelativePath('quadrotor_ball_free.urdf'),options);
      warning(w);
