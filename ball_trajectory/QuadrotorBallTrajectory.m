classdef QuadrotorBallTrajectory < RigidBodyManipulator
  
  methods
    function obj = QuadrotorBallTrajectory()
      options.floating = true; 
      options.terrain = RigidBodyFlatTerrain();
      w = warning('off','Drake:RigidBodyManipulator:ReplacedCylinder');
      warning('off','Drake:RigidBodyManipulator:UnsupportedContactPoints');
      obj = obj@RigidBodyManipulator(getFullPathFromRelativePath('quadrotor_ball_trajectory.urdf'),options);
      warning(w);
